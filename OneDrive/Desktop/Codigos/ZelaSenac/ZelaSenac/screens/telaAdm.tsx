...
export default function Admin () {
    ...
    const contarSalas  = async () => {
        try {
            ...
            const filtragem = data.filter((sala: { status_limpeza: string }) => sala.status_limpeza === 'Limpa')
            const filtro_naolimpas = data.filter((sala: { status_limpeza: string }) => sala.status_limpeza === 'Limpeza Pendente')
